...
public class shake_animationAnimation {
	public static final AnimationDefinition fall = AnimationDefinition.Builder.withLength(0.0F)
		...
		.addAnimation("right_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(-1.0F, -10.25F, 0.75F), AnimationChannel.Interpolations.LINEAR)
		))
		...
		.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(1.0F, -10.0F, 0.5F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();
}