...
public class Memories {
    ...
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<List<ItemStack>>> ITEM_TO_FIND = register("item_to_find", ItemStack.OPTIONAL_CODEC.listOf());
