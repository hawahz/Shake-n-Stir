...
public abstract class DoublePointElement<Self extends DoublePointElement<Self>> extends ColoredElement<Self>  {
    ...
    public void tick() {
        ...
        oPos0 = visualPos0;
        oPos1 = visualPos1;
        visualPos0 = visualPos0.lerp(actualPos0, deltaTicks.orElse(ShakenStirClient.ANI_DELTAF));
        visualPos1 = visualPos1.lerp(actualPos1, deltaTicks.orElse(ShakenStirClient.ANI_DELTAF));
    }
