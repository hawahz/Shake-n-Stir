...
public abstract class ColoredElement<Self extends ColoredElement<Self>> extends RenderElement<Self>{
    ...
    public void tick() {
        ...
        ob = b;
        oa = a;
        r = Mth.lerp(ShakenStirClient.ANI_DELTAF, r, targetR);
        g = Mth.lerp(ShakenStirClient.ANI_DELTAF, g, targetG);
        b = Mth.lerp(ShakenStirClient.ANI_DELTAF, b, targetB);
        a = Mth.lerp(ShakenStirClient.ANI_DELTAF, a, targetA);
    }
