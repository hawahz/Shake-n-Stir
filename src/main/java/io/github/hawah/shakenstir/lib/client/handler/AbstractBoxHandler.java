package io.github.hawah.shakenstir.lib.client.handler;

import io.github.hawah.shakenstir.Config;
import io.github.hawah.shakenstir.datagen.lang.LangData;
...
//        }
    ...
    protected boolean canPushOrPullFace() {
        return selectedFace != null && KeyBinding.hasAltDown();
    }

    protected boolean canReachAir() {
        return KeyBinding.hasControlDown() && (firstPos == null || secondPos == null);
    }
