...
public class DummySubmitNodeCollector implements OrderedSubmitNodeCollector, SubmitNodeCollector{

    @Nullable public List<BlockStateModelPart> blockParts = null;
    @Override
