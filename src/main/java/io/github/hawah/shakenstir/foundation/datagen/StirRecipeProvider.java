...
public class StirRecipeProvider extends RecipeProvider {
    private final HolderLookup.RegistryLookup<Item> items;
    private final HolderLookup.RegistryLookup<Fluid> fluids;
    protected StirRecipeProvider(HolderLookup.Provider registries, RecipeOutput output) {
    ...
    protected void buildRecipes() {
        getBuilder()
                ...
                .save(output, getName("fizz_product"));
        ...
        getBuilder()
                ...
                .build()
                .unlockedBy("has_spirit", this.has(SnsItemTags.SPIRIT))
                .save(output, getName("tonic_product"));
    ...
    public static class Runner extends RecipeProvider.Runner {
        ...
        protected RecipeProvider createRecipeProvider(HolderLookup.Provider provider, RecipeOutput output) {
            return new StirRecipeProvider(provider, output);
        }
    ...
    class Builder extends AbstractBuilder<Builder>{
        ...
        public StirRecipeBuilder build() {
            return new StirRecipeBuilder(
