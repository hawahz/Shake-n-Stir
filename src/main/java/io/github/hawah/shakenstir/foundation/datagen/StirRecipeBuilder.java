...
import io.github.hawah.shakenstir.foundation.recipe.StirRecipe;
...
public class StirRecipeBuilder implements RecipeBuilder {
    ...
    public StirRecipeBuilder(ItemStackTemplate result, List<FluidIngredient> inputFluid, List<Ingredient> inputItem, RecipeCategory category) {
        this.result = result;
    ...
    public void save(RecipeOutput output, ResourceKey<Recipe<?>> location) {
        StirRecipe recipe = new StirRecipe(
