package io.github.hawah.shakenstir.foundation.recipe.ingredient;
...
//    }
    ...
    public int match(FluidStack fluidStack) {
        return this.fluidId.test(fluidStack)? fluidStack.getAmount(): 0;
    }
}
