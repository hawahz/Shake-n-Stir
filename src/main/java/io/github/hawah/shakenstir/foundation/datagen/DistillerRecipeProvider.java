...
public class DistillerRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        getBuilder()
                ...
                .patch(DataComponentPatch.builder().set(DataComponentTypeRegistries.DEFERRED_FLUID, new DeferredFluidStackHolder(FluidRegistries.GIN_SOURCE, 100 /*MAGIC*/)).build())
                .with(ItemTags.LOGS).with(ItemTags.LOGS)
                .with(Tags.Items.CROPS_WHEAT)
                .withFluid(FluidTags.WATER, 1000 /*MAGIC*/)
                .cook(600)
                .build()
        ...
        getBuilder()
                .result(ItemRegistries.CONTENT_HOLDER)
                .patch(DataComponentPatch.builder().set(DataComponentTypeRegistries.DEFERRED_FLUID, new DeferredFluidStackHolder(FluidRegistries.VODKA_SOURCE, 100 /*MAGIC*/)).build())
        ...
        getBuilder()
                .result(ItemRegistries.CONTENT_HOLDER)
                .patch(DataComponentPatch.builder().set(DataComponentTypeRegistries.DEFERRED_FLUID, new DeferredFluidStackHolder(FluidRegistries.VODKA_SOURCE, 250 /*MAGIC*/)).build())
...
//                .save(output, getName("rum"));
    ...
    class Builder extends AbstractBuilder<Builder> {
        ...
        public Builder withFluid(TagKey<Fluid> tag) {
            this.fluidIngredient = FluidIngredient.of(fluids.getOrThrow(tag), 250 /*MAGIC*/);
            return this;
        }
